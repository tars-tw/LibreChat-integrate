...
export const darkTheme: IThemeRGB = {
  ...
  /** Slot 8 is upstream's neutral-leaning stop, muted rather than saturated
   *  indigo because a slot also fills a badge chip under `text-on-status`
   *  white: this reads 3.66:1 there. */
