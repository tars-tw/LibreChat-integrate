...
const resolveLoginAuthMiddleware = () => {
  if (tarsAuth) {
    return middleware.requireTarsAuth;
  }
  if (ldapAuth) {
    return middleware.requireLdapAuth;
  }
  return middleware.requireLocalAuth;
};
const loginAuthMiddleware = resolveLoginAuthMiddleware();
//Local
