  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'pwc-orange': {
          50: 'var(--pwc-orange-50)',
          100: 'var(--pwc-orange-100)',
          200: 'var(--pwc-orange-200)',
          300: 'var(--pwc-orange-300)',
          400: 'var(--pwc-orange-400)',
          500: 'var(--pwc-orange-500)',
          600: 'var(--pwc-orange-600)',
          700: 'var(--pwc-orange-700)',
          800: 'var(--pwc-orange-800)',
          900: 'var(--pwc-orange-900)',
          DEFAULT: 'var(--pwc-primary)',
        },
        'brand-primary': 'hsl(var(--brand-primary-hsl) / <alpha-value>)',
        'brand-primary-hover': 'hsl(var(--brand-primary-hover-hsl) / <alpha-value>)',
        'brand-primary-subtle': 'hsl(var(--brand-primary-subtle-hsl) / <alpha-value>)',
        'pwc-warning': 'var(--pwc-warning)',
        'pwc-success': 'var(--pwc-success)',
        'pwc-info': 'var(--pwc-info)',
        'pwc-danger': 'var(--pwc-danger)',
        'pwc-secondary': 'var(--pwc-secondary)',
        'pwc-dark': 'var(--pwc-dark)',
